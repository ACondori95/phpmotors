...
// Get the acocunts model\courses\191122
...
switch ($action) {
  case 'register':
    ...
    // echo 'You are now in the register case statement';
    break;
  ...
  case 'login':
    ...
    // A valid password exists, proceed with the login process. Query thr client data based on the email address.
